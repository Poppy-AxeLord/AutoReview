# AutoReview 代码审核多智能体团体


## 项目介绍
AutoReview 是一个基于AutoGen开发的多智能体的代码审核系统，旨在帮助开发团队快速、准确地审核代码变更，确保代码质量和系统稳定性。
该系统通过三个智能体并行审核：语法规范审核员、逻辑安全审核员和性能优化审核员。
每个审核员负责审核代码的不同方面，最终生成综合报告。


### 例如：先制造一个严重错误的PR
假设我们有一个 PR，其中包含以下变更：
- 删除了 `route_by_complexity` 函数的 `diff` 修改片段中的 `+    return` 行。
![img.png](./review_results/diff.png)
